...
def main_phython(lr, num_iter, sz):
    ...
    hiddenlayer_neurons = sz  # number of hidden layers neurons
    output_neurons = sz  # number of neurons at output layer
...
output = main_phython(0.1, 800, sz)
time_end = time.time()
